	...
	public struct ObscuredVector3
	{
		...
		public float x
		{
			get
			{
				...
				if (Detectors.ObscuredCheatingDetector.ExistsAndIsRunning && fakeValueActive && Mathf.Abs(decrypted - fakeValue.x) > Detectors.ObscuredCheatingDetector.Instance.vector3Epsilon)
				{
		...
		public float y
		{
			get
			{
				...
				if (Detectors.ObscuredCheatingDetector.ExistsAndIsRunning && fakeValueActive && Mathf.Abs((float)(decrypted - fakeValue.y)) > Detectors.ObscuredCheatingDetector.Instance.vector3Epsilon)
				{
					Detectors.ObscuredCheatingDetector.Instance.OnCheatingDetected();
				}
				return decrypted;
		...
		public float z
		{
			get
			{
				...
				if (Detectors.ObscuredCheatingDetector.ExistsAndIsRunning && fakeValueActive && Mathf.Abs(decrypted - fakeValue.z) > Detectors.ObscuredCheatingDetector.Instance.vector3Epsilon)
				{
					Detectors.ObscuredCheatingDetector.Instance.OnCheatingDetected();
				}
				return decrypted;
		...
		private bool CompareVectorsWithTolerance(Vector3 vector1, Vector3 vector2)
		{
			...
			return Mathf.Abs(vector1.x - vector2.x) < epsilon &&
                   Mathf.Abs(vector1.y - vector2.y) < epsilon &&
                   Mathf.Abs(vector1.z - vector2.z) < epsilon;
		}
