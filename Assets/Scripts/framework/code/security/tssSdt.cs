...
#define __TSS_DATATYPE_TEMPLATE__               //this marco should always be opened
#define __TSS_DATATYPE_GENERATE__               //this marco should always be opened
#define __TSS_DATETYPE_TEST_TEMPLATE__          //this marco should always be opened
#define __TSS_DATETYPE_TEST_GENERATE__          //this marco should always be opened
    ...
    public class TssSdtDataTypeFactory
    {
        ...
        public static byte GetByteXORKey()
        {
            if (m_byte_xor_key == 0)
            {
                ...
                m_byte_xor_key = (byte)rand.Next(0, 0xff);
            }
            //m_byte_xor_key++;
        ...
        public static short GetShortXORKey()
        {
            ...
            {
                Random rand = new Random();
                m_short_xor_key = (short)rand.Next(0, 0xffff);
            }
            //m_short_xor_key++;
        ...
        public static ushort GetUshortXORKey()
        {
            ...
            {
                Random rand = new Random();
                m_ushort_xor_key = (ushort)rand.Next(0, 0xffff);
            }
            //m_ushort_xor_key++;
        ...
        public static int GetIntXORKey()
        {
            ...
            {
                Random rand = new Random();
                m_int_xor_key = rand.Next(0, 0xffff);
            }
            //m_int_xor_key++;
        ...
        public static uint GetUintXORKey()
        {
            ...
            {
                Random rand = new Random();
                m_uint_xor_key = (uint)rand.Next(0, 0xffff);
            }
            //m_uint_xor_key++;
        ...
        public static long GetLongXORKey()
        {
            ...
            {
                Random rand = new Random();
                m_long_xor_key = (long)rand.Next(0, 0xffff);
            }
            //m_long_xor_key++;
        ...
        public static ulong GetUlongXORKey()
        {
            ...
            {
                Random rand = new Random();
                m_ulong_xor_key = (ulong)rand.Next(0, 0xffff);
            }
            //m_ulong_xor_key++;
...
#if (__TSS_DATATYPE_TEMPLATE__)     //do NOT edit this line
...
public class TssSdtUintSlot : TssSdtSlotBase
...
#endif
    {
        ...
        {
            _value = new uint[TssSdtDataTypeFactory.GetValueArraySize()];
            _index = TssSdtDataTypeFactory.GetRandomValueIndex() % _value.Length;
        }

        public void SetValue(uint v)
        {
            _xor_key = TssSdtDataTypeFactory.GetUintXORKey();
            int index = _index + 1;
            if (index == _value.Length)
            {
                index = 0;
    ...
    public class TssSdtUint
    {
        ...
        private uint GetValue()
        {
            if (_slot == null)
            {
                _slot = TssSdtUintSlot.NewSlot(null);
            }
            return _slot.GetValue();
        }
...
public class TssSdtLongSlot : TssSdtSlotBase
...
#endif
    {
        ...
        {
            _value = new long[TssSdtDataTypeFactory.GetValueArraySize()];
            _index = TssSdtDataTypeFactory.GetRandomValueIndex() % _value.Length;
        }

        public void SetValue(long v)
        {
            _xor_key = TssSdtDataTypeFactory.GetLongXORKey();
            int index = _index + 1;
            if (index == _value.Length)
            {
                index = 0;
    ...
    public class TssSdtLong
    {
        ...
        private long GetValue()
        {
            if (_slot == null)
            {
                _slot = TssSdtLongSlot.NewSlot(null);
            }
            return _slot.GetValue();
        }
...
public class TssSdtUlongSlot : TssSdtSlotBase
...
#endif
    {
        ...
        {
            _value = new ulong[TssSdtDataTypeFactory.GetValueArraySize()];
            _index = TssSdtDataTypeFactory.GetRandomValueIndex() % _value.Length;
        }

        public void SetValue(ulong v)
        {
            _xor_key = TssSdtDataTypeFactory.GetUlongXORKey();
            int index = _index + 1;
            if (index == _value.Length)
            {
                index = 0;
    ...
    public class TssSdtUlong
    {
        ...
        private ulong GetValue()
        {
            if (_slot == null)
            {
                _slot = TssSdtUlongSlot.NewSlot(null);
            }
            return _slot.GetValue();
        }
...
public class TssSdtShortSlot : TssSdtSlotBase
...
#endif
    {
        ...
        {
            _value = new short[TssSdtDataTypeFactory.GetValueArraySize()];
            _index = TssSdtDataTypeFactory.GetRandomValueIndex() % _value.Length;
        }

        public void SetValue(short v)
        {
            _xor_key = TssSdtDataTypeFactory.GetShortXORKey();
            int index = _index + 1;
            if (index == _value.Length)
            {
                index = 0;
    ...
    public class TssSdtShort
    {
        ...
        private short GetValue()
        {
            if (_slot == null)
            {
                _slot = TssSdtShortSlot.NewSlot(null);
            }
            return _slot.GetValue();
        }
...
public class TssSdtUshortSlot : TssSdtSlotBase
...
#endif
    {
        ...
        {
            _value = new ushort[TssSdtDataTypeFactory.GetValueArraySize()];
            _index = TssSdtDataTypeFactory.GetRandomValueIndex() % _value.Length;
        }

        public void SetValue(ushort v)
        {
            _xor_key = TssSdtDataTypeFactory.GetUshortXORKey();
            int index = _index + 1;
            if (index == _value.Length)
            {
                index = 0;
    ...
    public class TssSdtUshort
    {
        ...
        private ushort GetValue()
        {
            if (_slot == null)
            {
                _slot = TssSdtUshortSlot.NewSlot(null);
            }
            return _slot.GetValue();
        }
...
public class TssSdtByteSlot : TssSdtSlotBase
...
#endif
    {
        ...
        {
            _value = new byte[TssSdtDataTypeFactory.GetValueArraySize()];
            _index = TssSdtDataTypeFactory.GetRandomValueIndex() % _value.Length;
        }

        public void SetValue(byte v)
        {
            _xor_key = TssSdtDataTypeFactory.GetByteXORKey();
            int index = _index + 1;
            if (index == _value.Length)
            {
                index = 0;
    ...
    public class TssSdtByte
    {
        ...
        private byte GetValue()
        {
            if (_slot == null)
            {
                _slot = TssSdtByteSlot.NewSlot(null);
            }
            return _slot.GetValue();
        }
...
public class TssSdtFloatSlot : TssStdSlotBase
...
#endif
    {
        ...
        public void SetValue(float v)
        {
            ...
            _value[index] = TssSdtDataTypeFactory.GetFloatEncValue(v, _xor_key);
            _index = index;
        }
        public float GetValue()
        {
            uint v = _value[_index];
            float dec_v = TssSdtDataTypeFactory.GetFloatDecValue(v, _xor_key);
            return dec_v;
        }
    }
...
public class TssSdtDoubleSlot : TssStdSlotBase
...
#endif
    {
        ...
        public void SetValue(double v)
        {
            ...
            _value[index] = TssSdtDataTypeFactory.GetDoubleEncValue(v, _xor_key);
            _index = index;
        }
        public double GetValue()
        {
            ulong v = _value[_index];
            double dec_v = TssSdtDataTypeFactory.GetDoubleDecValue(v, _xor_key);
            return dec_v;
        }
    }
    ...
    public class TssSdtDouble
    {
        ...
        private double GetValue()
        {
            if (_slot == null)
            {
                _slot = TssSdtDoubleSlot.NewSlot(null);
            }
            return _slot.GetValue();
        }
...
{
    int m_raw_unassigned_variable;
    TssSdtInt m_enc_unassigned_variable;
